...
[gluesql/gluesql: GlueSQL is quite sticky. It attaches to anywhere.](https://github.com/gluesql/gluesql)

[EDB Docs - Demonstration of Oracle SQL compatible functions and syntax](https://www.enterprisedb.com/docs/biganimal/latest/using_cluster/06_demonstration_oracle_compatibility/)

[supabase | db | serverless postgres](https://supabase.io/)

[bit.io | db | serverless postgres](https://docs.bit.io/docs)

[cockroachdb | db | serverless postgres](https://cockroachlabs.cloud/clusters)

[yugabytedb | db | serverless postgres](https://docs.yugabyte.com/preview/develop/build-apps/nodejs/ysql-prisma/)

[planetscale | db | serverless mysql](https://planetscale.com/docs/tutorials/planetscale-serverless-driver)

[Neon | db | serverless postgres](https://console.neon.tech/app/projects)

[PingCAP | db | serverless mysql](https://pingcap.com/tidb-cloud-pricing/)

[HarperDB | db | serverless rdbms](https://harperdb.io/)

[dgraph | db | serverless graphql](https://dgraph.io/)

[rethinkdb | db | realtime](https://rethinkdb.com/)

[edgedb | db | ETL](https://www.edgedb.com/blog/designing-the-ultimate-typescript-query-builder)
...
[Redis Cloud Console](https://app.redislabs.com/#/login)
...
[Mycelial - The Best Platform for Synchronized Apps | Mycelial](https://mycelial.com/)

[PolyScale.ai | Serverless Database Edge Cache](https://www.polyscale.ai/)

[Litestream - Streaming SQLite Replication](https://litestream.io/)

[clientdb - OS in-memory database for real-time web apps](https://clientdb.dev/)

[layer0 edg.io](https://edg.io/)
